    ...
    <>
      ...
      <div>
        ...
        <section style={landingStyles.whatWeDo}>
          ...
          <p style={landingStyles.sectionText}>
            Here’s how it works: browse our curated newsfeed, updated in real-time with stories from trusted sources worldwide. For each article, you have three powerful options. Request an <strong>AI-generated summary</strong> to get the key points in seconds—perfect for when you’re short on time. Engage with our <strong>AI chat feature</strong> to ask questions about the story, from clarifying details to exploring topics or specifics within the article. You can, also, dive into the <strong>original article</strong> for the full experience, all seamlessly linked within the platform.
          </p>
          <p style={landingStyles.sectionText}>
